...
func SetupRoutes() {
	...
	http.HandleFunc("/submit_report", submitReportHandler)
	http.HandleFunc("/delete_post_report", deletePostReportHandler)
	http.HandleFunc("/delete", DeleteHandler)
	http.HandleFunc("/mod_delete", mod_deletePostHandler)
	http.HandleFunc("/apply-moderator", applyModeratorHandler)
	http.HandleFunc("/changeUserRole", ChangeUserRole)
	http.HandleFunc("/pending", pending)
	http.HandleFunc("/approve", approvePostHandler)
	http.HandleFunc("/reject", rejectPostHandler)
	http.HandleFunc("/admin/delete_comment", adminDeleteCommentHandler)
